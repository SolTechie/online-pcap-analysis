function delayShow(){
	...
	$.getJSON("http://121.199.35.74/delay_bar.json",function(res){
	    options = {
	...
	$("#innerTb").prepend("<tr><td style='text-align:center;'>序号</td><td style='text-align:center;'>IP地址对</td><td style='text-align:center;'>RTT 微秒</td><tr>");
	$.getJSON("http://121.199.35.74/delay_list.json",function(res){
	    for(var ind in res){
		$("#innerTb").append("<tr><td style='text-align:center;'>No."+ind+"</td><td style='text-align:center;'>"+res[ind]["ipPair"]+"</td><td style='text-align:center;'>"+res[ind]["rtt"]+"</td><tr>");
	    }
	});
	$(".mask").click(function(){
	    modalClose();
